...
const ProductConferenceDetail: React.FC<Props> = ({ onBack }) => {
  ...
  const galleryImages = [
    { src: "/product-conference.png", alt: "Product Conference 2.0 — Group Photo" },
    { src: "/conference-gallery-1.png", alt: "Auditorium — Product Conference audience" },
    { src: "/conference-gallery-2.png", alt: "Speakers and audience at Product Conference" },
    { src: "/conference-gallery-3.png", alt: "Attendees at event banner" },
    { src: "/conference-gallery-4.png", alt: "Product Conference — APMC Northeastern backdrop", objectPosition: "center -12px" as const }
  ];
